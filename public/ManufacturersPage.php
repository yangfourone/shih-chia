...
<html lang="en">
    ...
    <script type="text/JavaScript">
        jQuery(document).ready(function() {
            jQuery('#ManufacturersTable').DataTable({
                rowReorder: {
            ...
            jQuery('#ManufacturersTable').on('click', 'tr', function() {
        ...
        function LoadmanufacturersDataToTable(manufacturersData) {
            let manufacturersDataTable = jQuery('#ManufacturersTable').DataTable();
            manufacturersDataTable.clear().draw(false);
            for (let i in manufacturersData) {
        ...
        function delete_data() {
            jQuery.ajax({
                type: "POST",
                url: "../apiv1/manufacturers/delete/" + jQuery("#N").val(),
                dataType: "json",
                data: {},
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <span><i class="fa fa-handshake-o"></i>&nbsp;&nbsp;廠商資料表</span>
                        <div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-md-12 col-lg-12" align="right">
                        &nbsp;<button class="btn btn-dark" id="NewPatient">新增廠商</button>
                    </div>
                </div>
                <br>
